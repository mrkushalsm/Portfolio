...
export const MOBILE_APPS = [
    ...
    { id: "files", label: "Files", icon: FaFolder, color: METRO_COLORS.purple, action: "app", componentKey: "FileExplorer" },
    ...
    { id: "skills", label: "Skills", icon: FaFileCode, color: METRO_COLORS.cyan, action: "app", componentKey: "Skills" },
